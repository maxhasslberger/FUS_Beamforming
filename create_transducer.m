function [karray_t, el2mask_ids, mask2el_ids] = create_transducer(kgrid, t_name, sparsity_name, t_pos, t_rot)
...
% tr1_ids = find(el2mask_ids <= 128); % If only tr1 used -> refer to its indices in propagation matrix (A)
