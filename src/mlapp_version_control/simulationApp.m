    ...
    methods (Access = private)
        ...
        function UpdateButtonInitPushed(app, event)
            ...
            if ~strcmp(app.MediumSwitch.Value, 'Homogeneous')
                ...
                app.sv_obj = plot_results(app.kgrid, [], skull_arg, 'Medium Preview', [], app.t1w_filename, ...
                    app.plot_offset, app.grid_size, app.dx_factor, false, app.current_datetime, 'slice', app.SliceIndexEditField.Value, ...
