...
[surface_indices, cluster_labels] = find_surface_points_multiple_volumes(x, y, epsilon);

% Find n farthest points
init_ids = farthest_points(size(b_mask), stim_ids, min_dist, surface_indices, cluster_labels);
